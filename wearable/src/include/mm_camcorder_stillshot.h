...
========================================================================================*/
/**
 * Enumeration for capture flip
 */
enum {
	CAPTURE_FLIP_NONE = 0,
	CAPTURE_FLIP_HORIZONTAL,
	CAPTURE_FLIP_VERTICAL
};

/**
 * Enumeration for flip of video convert
 */
enum {
	VIDEO_CONVERT_FLIP_NONE = 0,
	VIDEO_CONVERT_FLIP_VERTICAL,
	VIDEO_CONVERT_FLIP_HORIZONTAL
};
...
typedef struct {
	...
	int capture_sound;				/**< capture sound index */
