...
typedef enum
{
	...
	MM_CAM_VIDEO_WIDTH,
	MM_CAM_VIDEO_HEIGHT,				/* 120 */
	MM_CAM_SUPPORT_ZSL_CAPTURE,
	MM_CAM_DISPLAY_HANDLE_USER_DATA,
	MM_CAM_AUTO_EXPOSURE_LOCK,
	MM_CAM_AUTO_WHITE_BALANCE_LOCK,			/* 124 */
	MM_CAM_NUM
}MMCamcorderAttrsID;
/**
 * Enumerations for inset window orientation.
 */
typedef enum {
	MM_CAM_INSET_WINDOW_ORIENTATION_LEFT = 0,	/**< the orientation of inset window is left */
	MM_CAM_INSET_WINDOW_ORIENTATION_DOWN,		/**< the orientation of inset window is down */
	MM_CAM_INSET_WINDOW_ORIENTATION_RIGHT,		/**< the orientation of inset window is right */
	MM_CAM_INSET_WINDOW_ORIENTATION_UP			/**< the orientation of inset window is up */
} MMCamcorderInsetWindowOrientation;
